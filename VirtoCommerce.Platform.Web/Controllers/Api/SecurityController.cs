        ...
        public async Task<IHttpActionResult> RequestPasswordReset(string loginOrEmail)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var notification = _notificationManager.GetNewNotification<ResetPasswordEmailNotification>("Platform", typeof(ResetPasswordEmailNotification).Name, Startup.DefaultLanguage);
